...
/**
 * AgentSanteDashboardComponent - AGENT_SANTE role dashboard
 * 
 * Displays personal activity statistics in MEDICAL domain including:
 * - My decisions count (own + ADMINISTRATEUR decisions in MEDICAL)
 ...
 * 
 * Backend applies agent scoping: own decisions + ADMINISTRATEUR decisions in MEDICAL domain.
 * Uses Angular signals for reactive state management.
 * 
 * Requirements: 5.1-5.11, 9.1-9.10, 15.3, 15.7, 18.1-18.10, 19.1-19.8
 */
@Component({
  selector: 'app-agent-sante-dashboard',
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
  ...
  templateUrl: './agent-sante-dashboard.component.html',
  styleUrls: ['./agent-sante-dashboard.component.scss']
})
export class AgentSanteDashboardComponent implements OnInit {
  /**
