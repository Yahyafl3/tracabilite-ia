...
/**
 * AgentCreditDashboardComponent - AGENT_CREDIT role dashboard
 * 
 * Displays personal activity statistics in CREDIT domain including:
 * - My decisions count (own + ADMINISTRATEUR decisions in CREDIT)
 ...
 * 
 * Backend applies agent scoping: own decisions + ADMINISTRATEUR decisions in CREDIT domain.
 * Uses Angular signals for reactive state management.
 * 
 * Requirements: 5.1-5.11, 9.1-9.10, 15.2, 15.6, 18.1-18.10, 19.1-19.8
 */
@Component({
  selector: 'app-agent-credit-dashboard',
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
  ...
  templateUrl: './agent-credit-dashboard.component.html',
  styleUrls: ['./agent-credit-dashboard.component.scss']
})
export class AgentCreditDashboardComponent implements OnInit {
  /**
